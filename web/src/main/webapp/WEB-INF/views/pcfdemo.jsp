...
<body style="margin:10px;padding:0px;height:75%">
    ...
    <div class="container">
    	<div class="nav-bar">
	        <div class="logo">
	          ...
	          <img src="resources/img/candidate_logo.jpg" alt="US presidential Candidates - 2016">
	          <img src="resources/img/election_logo.jpg" alt="US presidential Election 2016">
	...
	<!--
		...
		<c:choose>
			...
			<c:otherwise>
				<h2> Counting starts in few minutes, Stay Tuned!! </h2>
...
function click(d) {
  ...
  if (d && centered !== d) {
	...
	chart2.titleText="Voting count trend for "+d.properties.name;
